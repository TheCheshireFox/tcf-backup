...
internal static class BtrfsUtil
{
    ...
    [DllImport("btrfsutil", CallingConvention = CallingConvention.Cdecl, EntryPoint = "btrfs_util_create_snapshot")]
    ...
    [DllImport("btrfsutil", CallingConvention = CallingConvention.Cdecl, EntryPoint = "btrfs_util_delete_subvolume")]
