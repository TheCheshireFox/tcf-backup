...
namespace TcfBackup.Test.Source
{
    public class DirSourceTest
    {
        ...
        public void ThrowsIfDirectoryNotExists()
        {
            ...
            Assert.Catch<DirectoryNotFoundException>(() => _ = new DirSource(logger.Object, fsMock.Object, Directory));
        }
        ...
        public void PrepareDoNothing()
        {
            ...
            var source = new DirSource(logger.Object, fsMock.Object, Directory);
