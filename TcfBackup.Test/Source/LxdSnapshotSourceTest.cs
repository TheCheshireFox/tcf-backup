...
namespace TcfBackup.Test.Source
{
    public class LxdSnapshotSourceTest
    {
        ...
        public void ThrowsIfContainersMissing()
        {
            ...
            Assert.Catch<Exception>(() => _ = new LxdSnapshotSource(logger.Object, manager.Object, fsMock.Object, new[] { "container3", "container4" }, false));
        }
        ...
        public void NotThrowsIfContainersMissingAndIgnoreNonExistedIsSet()
        {
            ...
            _ = new LxdSnapshotSource(logger.Object, manager.Object, fsMock.Object, new[] { "container3", "container4" }, true);
        }
        ...
        public void PrepareCreatesBackupsOfEachContainer()
        {
            ...
            var source = new LxdSnapshotSource(logger.Object, manager.Object, fsMock.Object, s_containers.ToArray(), true);
        ...
        public void PrepareCreatesBackupsOnlyForExistedContainers()
        {
            ...
            var source = new LxdSnapshotSource(logger.Object, manager.Object, fsMock.Object, s_containers, true);
