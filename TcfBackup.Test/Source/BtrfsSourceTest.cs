...
namespace TcfBackup.Test.Source
{
    public class BtrfsSourceTest
    {
        ...
        public void ThrowsIfSubvolumeDoesNotExists()
        {
            ...
            Assert.Catch<DirectoryNotFoundException>(() => _ = new BtrfsSource(logger.Object, btrfsManagerMock.Object, fsMock.Object, Subvolume, SnapshotDir));
        }

        [Test]
        public void ThrowsIfSnapshotDirDoesNotExists()
        {
            var logger = new Mock<ILogger>(MockBehavior.Loose);
        ...
        public void PrepareCreatesSnapshot()
        {
            ...
            var btrfsSource = new BtrfsSource(logger.Object, btrfsManagerMock.Object, fsMock.Object, Subvolume, SnapshotDir);
        ...
        public void PrepareCallsNothingIfSnapshotDirIsNull()
        {
            ...
            var btrfsSource = new BtrfsSource(logger.Object, btrfsManagerMock.Object, fsMock.Object, Subvolume, null);
